...
namespace TMPro.Examples
{
    ...
    public class SkewTextExample : MonoBehaviour
    {
        ...
        IEnumerator WarpText()
        {
            ...
            m_TextComponent.havePropertiesChanged = true;               CurveScale *= 10;
            ...
            while (true)
            {
                ...
                float boundsMinX = m_TextComponent.bounds.min.x;                    float boundsMaxX = m_TextComponent.bounds.max.x;    
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    float x0 = (offsetToMidBaseline.x - boundsMinX) / (boundsMaxX - boundsMinX);                       float x1 = x0 + 0.0001f;
